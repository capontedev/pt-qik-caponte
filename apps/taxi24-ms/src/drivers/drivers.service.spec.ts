...
describe('DriversService', () => {
	...
	describe('getNearbyWithPagination', () => {
		...
		it('should throw RpcException when lat, lon, and maxDistance are not provided together', async () => {
			const query: DrivesQueryDto = {
				lat: 10.5061
			}
		...
		it('should throw RpcException when maxDistance is greater than 3', async () => {
			const query: DrivesQueryDto = {
				lat: 10.5061,
				lon: -66.9036,
				maxDistance: 5
	...
	describe('findOne', () => {
		...
		it('should throw RpcException when driver not found', async () => {
