...
import { TripsQueryDto } from '@app/libs/trips/dto/trip.dto'
...
describe('TripsService', () => {
	...
	describe('completeTrip', () => {
		...
		it('should throw RpcException if trip does not exist', async () => {
		...
		it('should throw RpcException if trip is not active', async () => {
